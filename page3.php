<?php
	...
	$str_sql_course = "SELECT * FROM course_tb INNER JOIN type_tb ON course_tb.course_f_type = type_tb.type_id WHERE course_f_status = 1 " . $str_condition;   
...
<body>
		<div class="section header">  
			<div class="inner-wrapper"> 
				<div class="lr">
					...
					<a class="c-r selected" href="page3.php">คอร์สเรียนที่กำลังเปิดลงทะเบียน</a>
					<a class="c-r" href="page2.php">คอร์สเรียนทั้งหมด</a>
		...
		<div class="section cover">
			<div class="inner-wrapper">
				<div>
					<h1><b>
Courses currently open for registration</b></h1>
		...
		<div class="section search">
			<div class="inner-wrapper">
					<form class="form1" name="frmdata" method="post" action="r_manager2.php">
